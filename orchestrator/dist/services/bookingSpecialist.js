...
exports.evaluateBooking = evaluateBooking;
const deterministicScheduling_1 = require("./deterministicScheduling");
function evaluateBooking(input) {
    ...
    if (deterministic && deterministic.applied) {
        ...
        let domainStatus = 'day_closed';
        let reasonCode = 'booking_day_closed';
        if (deterministic.code === deterministicScheduling_1.DETERMINISTIC_CODES.SLOTS_AVAILABLE) {
            domainStatus = 'exact_slot_available';
            reasonCode = 'booking_exact_slot_available';
        }
        else if (deterministic.code === deterministicScheduling_1.DETERMINISTIC_CODES.WORKING_TIME_VIOLATION) {
        ...
        else if (deterministic.code === deterministicScheduling_1.DETERMINISTIC_CODES.REQUESTED_DATE_NOT_OPEN) {
...
//# sourceMappingURL=bookingSpecialist.js.map